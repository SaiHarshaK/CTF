##List of lists
- [CTF Resources]https://github.com/ctfs/resources - Collection of information, tools, and tips regarding CTFs 
- [Awesome CTF]https://github.com/apsdehal/awesome-ctf - A curated list of CTF frameworks, libraries, resources and software
- [CTF-Resources]https://github.com/SkullTech/CTF-Resources - A list of resources related to CTFs, inspired by [Awesome CTF]https://github.com/apsdehal/awesome-ctf
- [Resources to Prepare for a Hacker CTF]https://resources.infosecinstitute.com/tools-of-trade-and-resources-to-prepare-in-a-hacker-ctf-competition-or-challenge/ - Tools and Resources to Prepare for a Hacker CTF Competition or Challenge by InfoSec Insitute.
- [Learning Resources]https://medium.com/@andr3w_hilton/learning-resources-a0a859bf9dbd These resorces are taken from a forum on picoctf.

##List of Frameworks
- [collabCTF](https://github.com/HackUCF/collabCTF) - A collaborative CTF framework written in Django.
- [Mellivora](https://github.com/Nakiami/mellivora) - A lightweight, scalable and flexible CTF engine in PHP
- [CTFd](https://github.com/CTFd/CTFd) - The CTF framework that powers CSAW CTF, focusing on ease of use and customizability
- [Wrath CTF Framework](https://github.com/WhiteHatCP/wrath-ctf-framework) - A simple flask webapp that requires minimal configuration and setup
...
- <del>[OpenToAll](http://wiki.opentoallctf.com/) - Open To All Knowledge Base</del>
